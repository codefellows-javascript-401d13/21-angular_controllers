...
describe('Cowsay Controller', function() {
  ...
  describe('initial properties', () => {
    it('title property should equal Welcome to Cowville!', () => {
      ...
      expect(this.cowsayCtrl.title2).toBe('cow creator.');
      expect(this.cowsayCtrl.slogan).toBe('make it, view it, and undo it!');
      expect(this.cowsayCtrl.brand).toBe('cowcontrol.io');
    });
